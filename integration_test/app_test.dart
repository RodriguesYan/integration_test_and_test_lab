...
import 'package:integration_test_and_fb_test_lab/main.dart';
...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      //Se for fazer um redirect ou qq coisa que tenha animação, tem que por esse cara
      await tester.pumpAndSettle();

      expect(find.byType(TypingPage), findsOneWidget);
      expect(find.byType(DisplayPage), findsNothing);
      expect(
        find.text('Input at least one character'),
        findsOneWidget,
      );
    },
  );
